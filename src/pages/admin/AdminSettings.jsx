...
const AdminSettings = () => {
  ...
  const [formData, setFormData] = useState({ usdtRate: 83, tokenRate: 0.01, minJTokenBuy: 10, referralPercent: 5, jTokenCommissionPercent: 4, usdtCommissionPercent: 0, upiRewardAmount: 50, bankRewardAmount: 100, telegramRewardAmount: 25, whatsappRewardAmount: 20, gamingRate: 103, gamingRateMin: 80, mixRate: 108, mixRateMin: 80, exchangeMinAmount: 100, exchangeMaxAmount: 50000 });
        ...
        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0d0d0d] rounded-3xl p-6 border border-[#2a2a2a]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div><label className="block text-gray-400 text-sm mb-2">Gaming Rate Min (₹)</label><input type="number" step="0.01" value={formData.gamingRateMin} onChange={(e) => setFormData({ ...formData, gamingRateMin: parseFloat(e.target.value) })} className="w-full px-5 py-4 bg-[#0a0a0a] border border-[#2a2a2a] rounded-2xl text-white focus:border-[#D4AF37] focus:outline-none" /></div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div><label className="block text-gray-400 text-sm mb-2">Mix Rate Min (₹)</label><input type="number" step="0.01" value={formData.mixRateMin} onChange={(e) => setFormData({ ...formData, mixRateMin: parseFloat(e.target.value) })} className="w-full px-5 py-4 bg-[#0a0a0a] border border-[#2a2a2a] rounded-2xl text-white focus:border-[#D4AF37] focus:outline-none" /></div>
            </div>
            <div className="grid grid-cols-2 gap-4">
