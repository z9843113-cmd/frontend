            ...
            <div className="space-y-4">
              <div className="bg-[#1a1a1a] rounded-xl p-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div><span className="text-gray-500">Mobile Verified:</span> <span className={userDetails.user?.mobileverified ? 'text-green-400 ml-1' : 'text-gray-500 ml-1'}>{userDetails.user?.mobileverified ? '✓ Verified' : 'Not Verified'}</span></div>
